...
[![Version 5.8.3-rc.2](https://img.shields.io/badge/version-5.8.3--rc.2-green.svg)](VERSION)
...
Older releases are preserved in Git tags and GitHub releases. The 5.2.0, 5.3.0, 5.3.x release-candidate, 5.4.0, 5.7.5, and former `4.0.0` rows are rolled off to respect the P9 changelog cap; their full bodies remain at their git tags.
