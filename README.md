...
[![Version 5.17.0-rc.5](https://img.shields.io/badge/version-5.17.0--rc.5-green.svg)](VERSION)
...
|---------|------|-------------|
| 5.17.0-rc.5 | 2026-05-12 | **fix(tests): update restart latch test for atomic JSON restart markers.** Aligns `test_request_restart_latches_reason_until_task_end` with the `atomic_write_json` restart-verification marker path introduced by the JSON state IO refactor, keeping quick-test green while preserving the latched-restart behavior. |
