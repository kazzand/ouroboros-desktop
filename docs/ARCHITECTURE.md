# Ouroboros v4.47.1 — Architecture & Reference
...
| Integration | Push to `ouroboros-stable`, manual, or tag `v*` | Ubuntu: `pytest -m integration` (real LLM API calls; ~$0.006/run; skipped when secrets absent) | ~1 min |
