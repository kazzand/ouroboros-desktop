...
- Codebase-wide function-count hard gate: 1115 Python functions/methods in `tests/test_smoke.py`.
...
- [ ] Total Python function count stays under the current smoke hard gate (1115)
