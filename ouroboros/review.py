...
# phase shipped.
MAX_TOTAL_FUNCTIONS = 1669  # v5.6.1: async widget jobs, download helper, and rate-limit retry helpers add real recovery surfaces; keep follow-up pressure on UI/helper consolidation.
